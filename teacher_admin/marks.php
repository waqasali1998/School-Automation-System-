                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="custom-select" name="subject">
                                                        <option selected disabled>Select Option</option>
                                                        <?php
$sql = 'SELECT DISTINCT(`subject`) FROM teacher_ass WHERE email = "'.$teacher_session.'"';
$result = mysqli_query($conn,$sql);
if($result)
{
    foreach($result as $row)
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <form action="marks-sub.php" method="post" enctype="multipart/form-data">
                                <div class="card-body">
...
if(isset($_POST['classs']))
{
    ...
    echo '<input type="hidden" name="class_subject" value="'. $_SESSION['sub'].'">';
    foreach($result2 as $row)
    {
          ...
          <td>'. $_SESSION['sub'].'<input type="hidden" name="id[]" value="'. $_SESSION['sub'].'"></td>
          <td><input class="form-control" type="number" name="marks[]" value="Enter marks">  </td>
       </tr> '; 
       $_SESSION['ii']++;
