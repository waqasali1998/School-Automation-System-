              ...
              <div  class="table-scrollable ">
                <table  id="example1" id="example2" class="table  table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
$sql = 'SELECT * FROM register_student where approve = "0" || approve = "1"';
...
<?php
               ...
               <a href="delete.php?delete_id=<?php echo $row['id']; ?>"><button class="btn btn-danger">Delete</button></a>

                 <?php
               } elseif($row['approve'] == 3){?>
              
              <a href="approve.php?approve_id=<?php echo $row['id']; ?>"><button class="btn btn-success">Approve</button></a>
