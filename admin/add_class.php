                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form  action="add_class_db.php" method="POST">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">Add New Class Name</label>
                                                    <input type="text" class="form-control" placeholder="Add New Class Name" name="class" placeholder="Enter email">
                                                </div>
                                            </div>
...
if($result)
{
    foreach($result as $row)
    {
        echo '<option value="'.$row['name'].'">'.$row['name'].'</option>';
                                        ...
                                        <button type="submit" class="btn btn-success" name="add_class">Add Book</button>
                                      <!-- <?php else: ?> -->
...
<td>
<a href="delete_class.php?sub_delete_id=<?php echo $row1['id']; ?>" onclick="con()">
