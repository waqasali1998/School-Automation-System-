    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="./pending_cv.php" class="nav-link">
            <i class="far fa-circle nav-icon"></i>
...
<!-- 
          ...
          <li class="nav-item">
            <a href="./teacher_ass.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="./class_search.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="./book_ass.php" class="nav-link">
          ...
          <li class="nav-item">
            <a href="./reviews_approve.php " class="nav-link">
            <i class="fa fa-address-book  nav-icon" aria-hidden="true"></i> 
            <!-- asad ka kaam  -->
              <p>Pending feedbacks
                <!-- <span class="right badge badge-danger">New</span> -->
