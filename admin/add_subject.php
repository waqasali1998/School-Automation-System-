                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card card-primary">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                <form  action="add_sub_db.php" method="POST">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-lg-6">
                                        ...
                                        <button type="submit" class="btn btn-success" name="add_subject">Add Book</button>
                                      <!-- <?php else: ?> -->
...
<td>
<a href="delete_book.php?sub_delete_id=<?php echo $row1['id']; ?>" onclick="con()">
