    ...
    <div class="container-fluid bg-primary px-0 px-md-5 mb-5">
        <div class="row align-items-center px-3">
            <div class="col-lg-6 text-center text-lg-left">
                ...
                <p class="text-white mb-4">Our goal is to foster a love of learning that will be the basis for a lifetime of growth, exploration and success.
We view parents as vital partners in this journey ahead. With commitment and enthusiasm we continue to stride
confidently in the field of education.</p>
                            ...
                            <form>
                                ...
                                <div class="form-group">
                                    <select class="custom-select border-0 px-4" style="height: 47px;">
                                        ...
                                        <option value="1">Prap 1</option>
                                        <option value="2">Prap 2</option>
                                        <option value="3">Prap 3</option>
                                    </select>
                                </div>
                                <div>
                                    <button hraf="admission.php" class="btn btn-secondary btn-block border-0 py-3" type="submit">Book Now</button>
                                </div>
                            </form>
                        </div>
                    </div>
