  ...
  ?>
    ...
    <div class="container-fluid bg-primary mb-5">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
            <h3 class="display-3 font-weight-bold text-white">Give a feedback</h3>
            <div class="d-inline-flex text-white">
                <p class="m-0"><a class="text-white" href="">Home</a></p>
                <p class="m-0 px-2">/</p>
                <p class="m-0">Give a feedback</p>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-7 mb-5 mb-lg-5">
                    <p class="section-title pr-5"><span class="pr-2">User feedback</span></p>
                    <h1 class="mb-4">Your opinion matters to us. Tell us how was your experience with us?</h1>
                    <!-- <p>Your opinion matters to us. Tell us how was your experience with us
</p> -->
                    <!-- <ul class="list-inline m-0">
                ...
                <div class="col-lg-12">
                    <div class="card border-0">
                        <div class="card-header bg-secondary text-center p-4">
                            <h1 class="text-white m-0">Enter your feedback</h1>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="tname" name="fname" class="form-control border-0 p-4"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="Contact" name="contact" class="form-control border-0 p-4"
                          ...
                          <label for="class" class="lebal_register">Position</label>
                              <br>
                               <select  class="form-sel border-0" id="class" name="position" aria-label="Default select example">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="expertise" class="lebal_register">Feedback</label>
                                            <textarea class="form-control" name="feedback" id="expertise" rows="3" placeholder="Write your feedback"></textarea>
                                        </div>
                                ...
                                <div>
                                    <button class="btn btn-secondary btn-block border-0 py-3" type="submit" name="pst">Post feedback</button>
                                </div>
                            </form>
                        </div>
                    </div>
